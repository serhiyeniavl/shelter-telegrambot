...
class DestroyCommandActionTest extends BaseSpringBootTestClass {
    ...
    void onDestroyCommandReceived() throws TelegramApiException {
        ...
        User expectedUser1 = saveUser(telegramUserId, UserActionState.WAITING_OTHERS_TO_JOIN, "en_US");
        User expectedUser2 = saveUser(telegramUserId + 1, UserActionState.WAITING_OTHERS_TO_JOIN, "en_US");
        User expectedUser3 = saveUser(telegramUserId + 2, UserActionState.WAITING_OTHERS_TO_JOIN, "en_US");
        User expectedUser4 = saveUser(telegramUserId + 3, UserActionState.WAITING_OTHERS_TO_JOIN, "en_US");
