...
public class HelpCommandAction extends AbstractCommandAction {
    ...
    public void handleCommand(TelegramLongPollingBot executor, Update update) {
        ...
        messageToSend.setText(messageSource.getMessage(MessageCode.HELP.getCode(), null, new Locale(user.getLocale())));
